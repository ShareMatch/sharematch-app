...
const TradeHistoryList: React.FC<TradeHistoryListProps> = ({ trades, assetName, assetId, assetLogo }) => {
    ...
    return (
        <div className="bg-[#02060a] rounded-xl border border-gray-800 flex flex-col h-[400px]">
            <div className="p-4 border-b border-gray-800 bg-[#0B1221] flex items-center justify-between">
                ...
                <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${isInWatchlist ? 'text-yellow-400 bg-yellow-400/10 border border-yellow-400/20' : 'text-gray-500 hover:text-gray-300 hover:bg-gray-800 border border-transparent'}`}
