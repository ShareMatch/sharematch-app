...
def main():
    ...
    cur.execute(
        ...
        SELECT
            mita.id,
            a.name,
            COALESCE(mita.primary_color, a.primary_color) as primary_color,
            COALESCE(mita.secondary_color, a.secondary_color) as secondary_color,
            COALESCE(mita.avatar_class, a.avatar_class) as avatar_class,
            COALESCE(a.market_token, m.market_token) as market_token
