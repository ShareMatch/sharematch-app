...
const ValuationSection: React.FC = () => {
    ...
    return (
        <div className="mt-8">
            <h3 className="text-2xl font-sans text-brand-amber500 mb-6">Why £64M Post-Money Valuation Is Justified</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {reasons.map((reason, idx) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="p-4 bg-gray-900/50 rounded-lg border border-gray-800 hover:border-brand-amber500/30 transition-colors"
                    >
                        <div className="flex items-start gap-3">
                            <reason.icon className="w-5 h-5 text-brand-amber500 mt-1 flex-shrink-0" />
                            <div>
