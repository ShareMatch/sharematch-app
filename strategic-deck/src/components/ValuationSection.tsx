...
const ValuationSection: React.FC = () => {
    const reasons = [
        { title: "Category Monopoly", desc: "Only Shariah-compliant trading venue worldwide.", icon: Crown },
        { title: "Regulatory Arbitrage", desc: "Skirts gambling defs via Shariah classification.", icon: ShieldCheck },
